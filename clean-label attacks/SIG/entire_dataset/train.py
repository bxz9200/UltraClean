...
parser.add_argument('-o', '--output_path', type=str, default='checkpoint', help="outputs path")
parser.add_argument('-r', "--resume", action="store_true", default=False)
parser.add_argument('-tr', "--train_file_name", type=str, default='dataset/GTSRB-new/train.txt')
