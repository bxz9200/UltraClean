...
parser.add_argument('-o', '--output_path', type=str, default='checkpoint_defensed', help="outputs path")
parser.add_argument('-r', "--resume", action="store_true", default=False)
parser.add_argument('-tr', "--train_file_name", type=str, default='dataset/GTSRB-new/train-defensed.txt')
parser.add_argument('-ts', "--test_file_name", type=str, default='dataset/GTSRB-new/test.txt')
