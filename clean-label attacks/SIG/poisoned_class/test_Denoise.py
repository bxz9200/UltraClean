...
state_dict = torch.load('retrain_cp_{}/outputs/GTSRB/checkpoints/classifier.pt'.format(target_class), map_location='cuda:{}'.format(0))
...
with open("testlog/target_{}.log".format(target_class), 'a') as fid_w:
    fid_w.write("******************************************************* \n")
    fid_w.write("Testing phase infomration:")
