...
poisoned_train_images = np.load("retrain_datasets/train_images_{}_{}.npy".format(detection_type,attack_type)).astype(np.float32)
poisoned_train_labels = np.load("retrain_datasets/train_labels_{}_{}.npy".format(detection_type,attack_type)).astype(np.int64)
