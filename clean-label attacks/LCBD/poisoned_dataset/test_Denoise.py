...
print("Testing after denoise detection, target class is: {}".format(target_class))
...
with open("testlog/{}.log".format(attack_type), 'a') as fid_w:
    fid_w.write("******************************************************* \n")
    fid_w.write(" Retrained model (denoised) test information:")
...
print("Testing after denoised detection Done, forward to SVD detection!")
