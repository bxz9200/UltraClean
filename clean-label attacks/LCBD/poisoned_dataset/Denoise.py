...
with open("testlog/{}.log".format(attack_type), 'w') as fid_w:
    fid_w.write("******************************************************* \n")
    fid_w.write("\n Attack type: {} \n".format(attack_type))
    fid_w.write("\n train image dir: {} \n".format(train_images_dir))
    fid_w.write("\n train labels dir: {} \n".format(train_labels_dir))
    fid_w.write("\n poisoned indiceds dir: {} \n".format(poisoned_indices_all_dir))
    fid_w.write("\n backdoor test images dir: {} \n".format(backdoor_test_images_dir))
    fid_w.write("\n backdoor test labels dir: {} \n".format(backdoor_test_labels_dir))
...
with open("testlog/{}.log".format(attack_type), 'a') as fid_w:
    fid_w.write("******************************************************* \n")
    fid_w.write("Original backdoored model test information:")
...
np.save("retrain_datasets/train_images_denoised_{}".format(attack_type), final_train_images)
np.save("retrain_datasets/train_labels_denoised_{}".format(attack_type), final_train_labels)
